...
const OUTPUT_FOLDER = path.join(process.cwd(), "case_outputs_ipc_498a");
...
const section_498a_cases = [
    // "Kans Raj v. State of Punjab (2000)",
    // "Sushil Kumar Sharma v. Union of India (2005)",
    // "Neelu Chopra & Anr. v. Bharti (2009)",
    // "Manju Ram Kalita v. State of Assam (2009)",
    ...
    // "Dara Lakshmi Narayana v. State of Telangana (2022)",
    // "Charan Singh v. State of Kerala (2022)",
    // "Yashodeep Bisanrao Vadode v. State of Maharashtra (2024)",
    // "Mariano Anto Bruno v. State (2022)",
    // "Reema Aggarwal v. Anupam (2004)",
    // "Shivcharan Lal Verma v. State of Madhya Pradesh (2007)",
    // "Shobha Devi & Ors. v. State of Jharkhand & Ors. (2012)",
    // "Rishi Anand & Anr. v. Government of N.C.T. of Delhi & Ors. (2002)",
    // "Baburam v. State of Madhya Pradesh (2002)",
    // "Vijayan v. State of Kerala & Anr. (2010)",
    // "Union of India v. Prafulla Kumar Samal & Anr. (1979)",
    // "Sajjan Kumar v. CBI (2010)",
    // "State of Tamil Nadu v. N. Suresh Rajan (2014)",
    // "Ratilal Bhanji Muthani v. State of Maharashtra (1979)",
    // "Stree Atyachar Virodhi Parishad v. Dilip Nathumal Chordiya (1989)",
    // "Tapati Bag v. Patipaban Ghosh (1996)",
    // "Madhu Pamnani v. Hanish Pamnani & Anr. (2014)",
...
async function analyzeCase(caseTitle) {
    try {
        ...
        const errorData = {
            ...
            stack: error.stack,
            timestamp: new Date().toISOString(),
            lastSuccessfulCase: section_498a_cases[section_498a_cases.indexOf(caseTitle) - 1] || null
        };
...
async function processAllCases() {
    ...
    for (const caseTitle of section_498a_cases) {
        try {
            ...
            // Rate limiting
            if (section_498a_cases.indexOf(caseTitle) < section_498a_cases.length - 1) {
