...
const section_302_cases = [
    ...
    // "State of Uttar Pradesh v. Naresh (2011)",
    // "State of Punjab v. Gurmit Singh (1996)",
    "State of Karnataka v. Krishnappa (2000)",
    "State of Rajasthan v. Om Prakash (2002)",
    // "State of Uttar Pradesh v. Pappu (2005)",
    // "State of Madhya Pradesh v. Babulal (2008)",
...
async function analyzeCase(caseTitle) {
    try {
        ...
        const errorData = {
            ...
            stack: error.stack,
            timestamp: new Date().toISOString(),
            lastSuccessfulCase: section_302_cases[section_302_cases.indexOf(caseTitle) - 1] || null
        };
...
async function processAllCases() {
    ...
    for (const caseTitle of section_302_cases) {
        try {
            ...
            // Rate limiting
            if (section_302_cases.indexOf(caseTitle) < section_302_cases.length - 1) {
